export const dict = {
    biography: {
        ...
        references: {
            title: 'references()',
            description: 'For improving my tech skills I often use CodeWars and try to solve some interesting tasks'
        },
    ...
    references: {
        codeWars: {
            points: 'Honor',
            description: 'Languages that i use:'
        },

        medium: {
            title: 'When i want to share with my experience and find some interesting information - i use Medium',
